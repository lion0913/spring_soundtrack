package com.lion.spring_soundtrack.util;
...
public class Util {
    ...
    public static class spring {
        ...
        public static <T> ResponseEntity<ResultData> responseEntityOf(ResultData<T> rsData) {
            return responseEntityOf(rsData, null);
        }

        public static <T> ResponseEntity<ResultData> responseEntityOf(ResultData<T> rsData, HttpHeaders headers) {
